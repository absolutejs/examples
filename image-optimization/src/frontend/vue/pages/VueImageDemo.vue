...
import { Image } from "@absolutejs/absolute/vue/components/Image.js";
  ...
  <div>
    ...
    <main>
      ...
      <p class="section-desc">
        Each image below uses the &lt;Image&gt; component with width, height,
        and sizes. The component generates responsive srcset attributes and
        serves optimized images through the /_absolute/image endpoint.
      </p>
      ...
      <p class="section-desc">
        ...
        and sets loading="eager" + fetchPriority="high" for above-the-fold
        images.
      </p>
