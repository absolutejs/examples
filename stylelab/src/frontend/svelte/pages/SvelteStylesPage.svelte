<script lang="ts">
  ...
  export let style: "less" | "scss" | "stylus" | "tailwind" = "scss";
...
<svelte:head>
  <title>AbsoluteJS StyleLab - Svelte {labels[style]}</title>
...
{#if style === "tailwind"}
  <div class="min-h-screen bg-[var(--t-bg)] text-[var(--t-text)]">
    <header
    ...
    >
      ...
      >
        {#each styleRows as [styleId, label]}
          <div
          ...
          >
            <span
              ...
              >{label}</span
            >
            {#each frameworks as [framework, frameworkLabel]}
              <a
                class={tailwindLink(
                  framework === "svelte" && styleId === style,
                )}
      ...
      >
        ...
        >
          ...
          <ul class="m-0 grid list-none gap-2 p-0">
            ...
            >
              <span class="text-[var(--t-muted)]">Parent state</span><strong
                class="text-[var(--t-label-active)]">active</strong
              >
            </li>
            <li
              class="flex items-center justify-between rounded-md bg-[var(--t-surface-2)] px-3 py-2"
            >
              <span class="text-[var(--t-muted)]">Child selector</span><strong
                class="text-[var(--t-label-active)]">hover</strong
              >
            </li>
            <li
              class="flex items-center justify-between rounded-md bg-[var(--t-surface-2)] px-3 py-2"
            >
              <span class="text-[var(--t-muted)]">Inline target</span><strong
                class="text-[var(--t-label-active)]">focus</strong
              >
            </li>
          </ul>
        </article>
        ...
        >
          ...
          <div class="mt-auto flex h-12 items-end gap-2">
            <span class="h-4 flex-1 rounded-md bg-emerald-300"></span><span
              class="h-6 flex-1 rounded-md bg-emerald-400"
            ></span><span class="h-8 flex-1 rounded-md bg-emerald-500"
            ></span><span class="h-10 flex-1 rounded-md bg-emerald-600"></span>
          </div>
        </article>
        <article
        ...
        >
          ...
          <div class="mt-auto grid gap-2">
            <span class="h-3 w-full rounded-full bg-fuchsia-600"></span><span
              class="h-3 w-3/4 rounded-full bg-fuchsia-500"
            ></span><span class="h-3 w-1/2 rounded-full bg-fuchsia-400"></span>
          </div>
        </article>
        <article
        ...
        >
          ...
          <p class="m-0 text-[13px] leading-[1.45] text-[var(--t-muted)]">
            ...
            rewritten at build time so <code>.card</code> here can't collide with
...
{:else}
        ...
        <div class="demo-nav-row">
          <span
            class={styleId === style
              ...
              : "demo-nav-row-label"}>{label}</span
          >
          {#each frameworks as [framework, frameworkLabel]}
            <a
              class={framework === "svelte" && styleId === style
                ? "active"
                : ""}
              href={getStylePath(framework, styleId)}
            >
  ...
  <main>
    <section class="hero">
      ...
      <p class="lede">
        AbsoluteJS compiles the selected stylesheet and wires it into this page.
      </p>
    </section>
    <section class="feature-grid">
      <article class="feature-card feature-card-primary">
        ...
        <div class="swatch-row">
          <span class="swatch swatch-one"></span><span class="swatch swatch-two"
          ></span><span class="swatch swatch-three"></span>
        </div>
      </article>
      ...
      <article class="feature-card feature-card-generated">
        ...
        <div class="utility-row">
          <span class="utility-chip utility-chip-1">1</span><span
            class="utility-chip utility-chip-2">2</span
