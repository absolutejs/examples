        ...
        >
          ...
          >
            ...
            <div class="mt-auto flex h-12 items-end gap-2">
              ...
              ></span><span class="h-10 flex-1 rounded-md bg-emerald-600"
              ></span>
            </div>
          </article>
          <article
          ...
          >
            ...
            <div class="mt-auto grid gap-2">
              ...
              ></span><span class="h-3 w-1/2 rounded-full bg-fuchsia-400"
              ></span>
            </div>
          </article>
          <article
      ...
      <section class="feature-grid">
        <article class="feature-card feature-card-primary">
          ...
          <div class="swatch-row">
            <span class="swatch swatch-one"></span><span
              class="swatch swatch-two"
