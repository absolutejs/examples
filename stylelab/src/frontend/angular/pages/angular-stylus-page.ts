  ...
  template: `
    <header>
      ...
      <nav>
        ...
        <div class="demo-nav-row">
          <span class="demo-nav-row-label">Less</span
          ><a href="/react/less">React</a><a href="/svelte/less">Svelte</a
          ><a href="/vue/less">Vue</a><a href="/angular/less">Angular</a
          ><a href="/html/less">HTML</a><a href="/htmx/less">HTMX</a>
        </div>
        <div class="demo-nav-row">
          <span class="demo-nav-row-label active">Stylus</span
          ><a href="/react/stylus">React</a><a href="/svelte/stylus">Svelte</a
          ><a href="/vue/stylus">Vue</a
          ><a class="active" href="/angular/stylus">Angular</a
...
export class AngularStylusPageComponent {}
