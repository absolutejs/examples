...
@Component({
  ...
  selector: "angular-tailwind-page",
  standalone: true,
  template: `
    <div class="min-h-screen bg-[var(--t-bg)] text-[var(--t-text)]">
      ...
      >
        ...
        >
          ...
          >
            <span
              class="mr-[0.35rem] text-[0.76rem] font-semibold uppercase leading-[normal] text-[var(--t-label-active)]"
              >Tailwind</span
            >
            <a
              class="rounded-full bg-[var(--t-nav-link-bg)] px-[10px] py-[7px] text-[0.8rem] leading-[normal] text-[var(--t-nav-link)] no-underline transition-colors hover:bg-[var(--t-nav-link-bg-hover)] hover:text-[var(--t-nav-link-hover)]"
              href="/react/tailwind"
              >React</a
            >
            <a
              class="rounded-full bg-[var(--t-nav-link-bg)] px-[10px] py-[7px] text-[0.8rem] leading-[normal] text-[var(--t-nav-link)] no-underline transition-colors hover:bg-[var(--t-nav-link-bg-hover)] hover:text-[var(--t-nav-link-hover)]"
              href="/svelte/tailwind"
              >Svelte</a
            >
            <a
              class="rounded-full bg-[var(--t-nav-link-bg)] px-[10px] py-[7px] text-[0.8rem] leading-[normal] text-[var(--t-nav-link)] no-underline transition-colors hover:bg-[var(--t-nav-link-bg-hover)] hover:text-[var(--t-nav-link-hover)]"
            ...
            >
            <a
              class="rounded-full bg-[var(--t-nav-link-bg-active)] px-[10px] py-[7px] text-[0.8rem] leading-[normal] text-[var(--t-nav-link-active)] no-underline transition-colors"
              href="/angular/tailwind"
              >Angular</a
            >
            <a
              class="rounded-full bg-[var(--t-nav-link-bg)] px-[10px] py-[7px] text-[0.8rem] leading-[normal] text-[var(--t-nav-link)] no-underline transition-colors hover:bg-[var(--t-nav-link-bg-hover)] hover:text-[var(--t-nav-link-hover)]"
          ...
          >
            <span
              class="mr-[0.35rem] text-[0.76rem] font-semibold uppercase leading-[normal] text-[var(--t-label)]"
              >SCSS</span
            >
            <a
              class="rounded-full bg-[var(--t-nav-link-bg)] px-[10px] py-[7px] text-[0.8rem] leading-[normal] text-[var(--t-nav-link)] no-underline transition-colors hover:bg-[var(--t-nav-link-bg-hover)] hover:text-[var(--t-nav-link-hover)]"
...
export class AngularTailwindPageComponent {}
