  ...
  template: `
    <header>
      ...
      <nav>
        ...
        <div class="demo-nav-row">
          <span class="demo-nav-row-label active">SCSS</span
          ><a href="/react/scss">React</a><a href="/svelte/scss">Svelte</a
          ><a href="/vue/scss">Vue</a
          ><a class="active" href="/angular/scss">Angular</a
...
export class AngularScssPageComponent {}
