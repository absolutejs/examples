...
| [`e2ee/`](./e2ee)                                               | Agency-authorized, single-use, model-blind protected-value exchange over explicit E2EE                     | `@absolutejs/agent-exchange`                                  |
...
| [`secure-messaging-federation/`](./secure-messaging-federation) | Strict E2EE federation plus a DPoP-bound managed inbox agent and device authorization                      | `@absolutejs/secure-messaging-federation`, `@absolutejs/auth` |
| [`secure-messaging-durability/`](./secure-messaging-durability) | Authoritative applied/retry/conflict resolution after a lost database durability acknowledgement          | `@absolutejs/secure-messaging`                               |
