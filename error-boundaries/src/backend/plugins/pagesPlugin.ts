...
import type * as AngularBrokenPage from "../../frontend/angular/pages/AngularBroken/AngularBroken";
import type * as AngularHomePage from "../../frontend/angular/pages/AngularHome/AngularHome";
