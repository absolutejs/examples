...
import { assistant, traceTimelineStore } from "./profileSwitch";
import {
...
import type { VoiceSTTProvider } from "./providers";

import type { VoicePluginConfig } from "@absolutejs/voice";

export const voiceSurfaces = {
  opsStatus: {
    deliverySinks: {
      auditDeliveries: {
  ...
  VoicePluginConfig<unknown, VoiceSessionRecord, SavedIntake>
>;
