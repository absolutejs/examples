...
export {
  ...
  getRecoveryProofChromePort,
  isMissingFileError,
  latestBrowserCallProfilesJsonPath,
  latestProofPackJsonPath,
  latestProofPackMarkdownPath,
  latestProofTrendsJsonPath,
  latestProofTrendsMarkdownPath,
  listDeliveryTraceEvidenceSafely,
  liveLatencyReadinessMaxAgeMs,
  longProofWindowRoot,
  proofTrendsMaxAgeMs,
  readLatestBrowserCallProfiles,
  readLatestProofTrends,
  readRealCallEvidenceRuntimeBrowserEvidence,
  readRealCallEvidenceRuntimePhoneEvidence,
  readRealCallEvidenceRuntimeProviderRoleEvidence,
  ...
  resolveProfileProviderRoute,
  resolveRecoveryProofBaseUrl,
  runBrowserCallProfileRecoveryProof,
  runPhoneSmokeRecoveryProof,
  runRecoveryProofScript,
  sloCalibrationMinRuns,
  sttAdapter,
  sttRouters,
  telephonyTTS,
};
export type { VapiCoverageEvidence, VapiCoverageResult, VapiCoverageSummary };
