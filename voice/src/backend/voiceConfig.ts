...
import { handoffAdapters, receivedWebhookEnvelopes } from "./carrierHandoff";
import {
  campaignStore,
...
export const intakeVoiceConfig = createVoiceConfiguration<
  unknown,
  VoiceSessionRecord,
  SavedIntake
>({
...
export { createTelephonyBridgeConfig };
