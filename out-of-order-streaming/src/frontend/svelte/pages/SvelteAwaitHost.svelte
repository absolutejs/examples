...
<div class="page">
  ...
  <main>
    ...
    <p class="section-desc">
      This page uses real <code>#await</code> blocks. AbsoluteJS lowers them into
      the out-of-order slot transport, so the authoring model stays Svelte-native.
    </p>
    ...
    <section class="grid">
      ...
      {:then value}
        <article class="stream-card stream-card-svelte">
          ...
          <p class="stream-desc">
            Authored as Svelte markup and rendered to streamed HTML on the
            server.
          </p>
