<template>
  <div>
    ...
    <p>
      ...
      already shows the matching view because vue-router was navigated
      to the request URL <em>by AbsoluteJS</em> before SSR streamed —
      this page exports <code>routes</code> and nothing else.
    </p>
  </div>
</template>
