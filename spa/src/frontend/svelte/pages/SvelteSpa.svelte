  ...
  <Router {url}>
    <main>
      ...
      <p class="section-desc">
        ...
        page handler forwards the request URL into the page's props, and the
        page passes that into <code>&lt;Router url=&#123;url&#125;&gt;</code> on the
        server.
      </p>
          ...
          <Route path="/svelte">
            {#snippet content()}
              ...
              <p>
                ...
                updates, this content swaps, and the sidebar + click counter
                stay mounted.
              </p>
              <p>
          ...
          <Route path="/svelte/profile">
            {#snippet content()}
              ...
              <p>
                ...
                intact, and the URL bar shows <code>/svelte/profile</code>.
                That's intra-framework SPA — the framework's own router doing
